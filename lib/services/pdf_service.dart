...
/// (31 din + total row shoho) fit korার jonne row padding/font/spacing
/// shob tightly compact kora hoyeche.
class PdfService {
  Future<void> exportMonth({
    ...
    doc.addPage(
      pw.MultiPage(
        ...
        margin: const pw.EdgeInsets.fromLTRB(26, 20, 26, 16),
        build: (context) => [
          pw.Column(
        ...
        pw.Column(
          ...
          children: [
            ...
            if (metaBits.isNotEmpty)
              pw.Text(metaBits, style: const pw.TextStyle(fontSize: 8.5, color: PdfColors.grey700)),
          ],
        ),
    ...
    return pw.Table(
      ...
      children: [
        pw.TableRow(
          ...
          children: [
            _cell('DATE', bold: true, fontSize: 7.5),
            _cell('OT(H)', bold: true, center: true, fontSize: 7.5),
            _cell('NIGHT DUTY', bold: true, center: true, fontSize: 7.5),
            _cell('OFF DAY DUTY', bold: true, center: true, fontSize: 7.5),
            _cell('OFF DAY', bold: true, center: true, fontSize: 7.5),
          ],
        ),
        ...List.generate(days.length, (i) {
          ...
          return pw.TableRow(children: [
            _cell(dateLabel, fontSize: 7.5),
            _cell(_num(e.ot), center: true, fontSize: 7.5),
            _cell(e.hasNight ? 'Y' : '', center: true, fontSize: 7.5),
            _cell(e.hasDuty ? 'Y' : '', center: true, fontSize: 7.5),
            _cell(e.hasDayoff ? 'Y' : '', center: true, fontSize: 7.5),
          ]);
        }),
        ...
        pw.TableRow(
          ...
          children: [
            _cell('TOTAL', bold: true, fontSize: 7.5),
            _cell(_num(totOT), bold: true, center: true, fontSize: 7.5),
            _cell('$totNight', bold: true, center: true, fontSize: 7.5),
            _cell('$totDuty', bold: true, center: true, fontSize: 7.5),
            _cell('$totDayOff', bold: true, center: true, fontSize: 7.5),
          ],
        ),
      ],
    );
  ...
  pw.Widget _cell(String text, {bool bold = false, bool center = false, double fontSize = 7.5}) => pw.Padding(
