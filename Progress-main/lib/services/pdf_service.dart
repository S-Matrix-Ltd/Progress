        ...
        build: (context) => [
          pw.Column(
            ...
            children: [
              ...
              // NOTE: age ekhane '•' (bullet) character use hoto ekই line-e
              // multiple text jora lagate — kintu PDF-er base font-e oi
              // bullet glyph na thakay eta khali "cross-box"/tofu hoye
              // dekhाচ্ছিলো। Tai ekhon প্রতিটা line আলাদা, kono special
              // unicode symbol chara.
              pw.Center(
    ...
    return pw.Row(
      ...
      children: [
        ...
        pw.Column(
          ...
          children: [
            pw.Text('MONTH OF', style: const pw.TextStyle(fontSize: 8, color: PdfColors.grey500)),
            pw.SizedBox(height: 2),
